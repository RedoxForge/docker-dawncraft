...
if ! [[ -f 'DawnCraft%202.0.12%20Serverpack.zip' ]]; then
	rm -fr config kubejs libraries mods *.zip forge*.jar
	curl -Lo 'DawnCraft%202.0.12%20Serverpack.zip' 'https://edge.forgecdn.net/files/5571/787/DawnCraft%202.0.12%20Serverpack.zip' && unzip -u -o 'DawnCraft%202.0.12%20Serverpack.zip' -d /data
