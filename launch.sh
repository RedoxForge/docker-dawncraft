...
if ! [[ -f 'DawnCraft%202.0.1_f%20Beta%20Serverpack.zip' ]]; then
	rm -fr config kubejs libraries mods *.zip forge*.jar
	curl -Lo 'DawnCraft%202.0.1_f%20Beta%20Serverpack.zip' 'https://edge.forgecdn.net/files/5176/999/DawnCraft%202.0.1_f%20Beta%20Serverpack.zip' && unzip -u -o 'DawnCraft%202.0.1_f%20Beta%20Serverpack.zip' -d /data
